...
public class HomePropertiesTab extends Fragment implements MyAdapter2.OnItemListener, MyAdapter4.OnItemListener, AdapterView.OnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root =inflater.inflate(R.layout.home_properties_tab_2, container, false);
...
//        final RecyclerView recyclerView = (RecyclerView) root.findViewById(R.id.recyclerView);
        final RecyclerView recyclerView2 = (RecyclerView) root.findViewById(R.id.recyclerViewProperties);
